    ...
    <div>
      <footer className="footer md:grid-cols-4 p-10 gap-16 bg-base-200 text-base-content">
        ...
        <div>
          ...
          <a className="link link-hover">Cricket Classes</a>
          <a className="link link-hover">Football Classes</a>
          <a className="link link-hover">Tennis Classes</a>
          <a className="link link-hover">Golf Classes</a>
        </div>
        <div>
